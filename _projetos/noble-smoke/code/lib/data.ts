...
export const PRODUCTS = [
  // SEDAS
  {
    ...
    rating: 43,
    media: [
      { type: "image", url: "/seda/noblesmoke_Seda_OCB_slim😉__tabacaria__tabacariadelivery__tabaco__smokes_2026-02-27_DVRqkQkjzcJ_3842039166771607305.jpg" }
    ],
    variations: [
  ...
  },
  {
    ...
    rating: 27,
    media: [
      { type: "image", url: "/seda/noblesmoke_A_seda_Sadhu_Slim_longa_é_um_papel_de_enrolar_premium_da_mar_2026-03-12_DVzTEusj723_3851505994233265591.jpg" }
    ],
  ...
  },
  {
    ...
    rating: 120,
    media: [
      { type: "image", url: "/seda/noblesmoke_Mais_novidades_chegando😉_Seda_Raw_Classic_e_Black__tabacaria_2026-02-23_DVGxOZfjlLe_3838972226104611550.jpg" },
      { type: "image", url: "/seda/noblesmoke_Mais_novidades_chegando😉_Seda_Raw_Classic_e_Black__tabacaria_2026-02-23_DVGxOZfjlLe_3838972226104611550_2.jpg" }
    ],
    variations: [
  ...
  },
  {
    ...
    rating: 85,
    media: [
      { type: "image", url: "/seda/noblesmoke__bembolado_2026-01-18_DTp9_b8jv9k_3812851199717080932.jpg" },
      { type: "image", url: "/seda/noblesmoke__bembolado_2026-01-18_DTp_89ljhje_3812859825772959966.jpg" }
    ],
  ...
  },
  {
    ...
    rating: 112,
    media: [
      { type: "image", url: "/seda/noblesmoke__smokingdeluxe_2026-01-17_DToU46kj8Wf_3812388956680471967.jpg" },
      { type: "image", url: "/seda/noblesmoke__Smokingdeluxe_2026-01-18_DTp_UMADvbh_3812857023751452385.jpg" }
    ],
  ...
  // ISQUEIROS
  {
    ...
    rating: 64,
    media: [
      { type: "image", url: "/esqueiros/noblesmoke_Isqueiros_Clipper,_Firestar_Fruits_e_Bic😉_sempre_com_os_melh_2026-02-20_DU_Ayh2jsdt_3836788879865595757.jpg" },
      { type: "image", url: "/esqueiros/noblesmoke_Isqueiros_Clipper,_Firestar_Fruits_e_Bic😉_sempre_com_os_melh_2026-02-20_DU_Ayh2jsdt_3836788879865595757_2.jpg" }
    ],
    variations: [
  ...
  },
  {
    ...
    rating: 33,
    media: [
      { type: "video", url: "/insta/noblesmoke__tabacaria__zippo__tabacariadelivery__perdizespompeia__charu_2026-07-03_DaWNlX9PY39_3933391067503496701.mp4" },
      { type: "image", url: "/esqueiros/noblesmoke__maçaricozengaz_2026-01-17_DToMBxKD56u_3812349982628880046.jpg" }
    ],
  ...
  },
  {
    ...
    rating: 215,
    media: [
      { type: "image", url: "/esqueiros/noblesmoke__bicmaxi_2026-01-17_DToLsNoj17K_3812348501376851658.jpg" }
    ],
  ...
  // BANDEJAS
  {
    ...
    rating: 56,
    media: [
      { type: "image", url: "/bandeja/noblesmoke_Bandejas_RAW_lindíssimas,_garanta_já_a_sua😉__tabacaria__taba_2026-03-28_DWbrWEAjl4c_3862871737533095452.jpg" },
      { type: "image", url: "/bandeja/noblesmoke_Bandejas_RAW_lindíssimas,_garanta_já_a_sua😉__tabacaria__taba_2026-03-28_DWbrWEAjl4c_3862871737533095452_2.jpg" }
    ],
    variations: [
  ...
  },
  {
    ...
    rating: 41,
    media: [
      { type: "image", url: "/bandeja/noblesmoke_Bandejas_Smoking_e_Sadhu,_melhor_qualidade_em_acessórios!!___2026-02-04_DUW39Dnjpjm_3825491021828888806.jpg" },
      { type: "image", url: "/bandeja/noblesmoke_Novidade_por_aqui_bandejas_smoking_lindíssimas👌🏻_Vem_garanti_2026-05-07_DYDARMJFRs3_3891955684246625079.jpg" }
    ],
  ...
  // CASES & KITS
  {
    ...
    rating: 74,
    media: [
      { type: "image", url: "/case/noblesmoke__guruspirit__sadhu_2026-01-18_DTqCpEIDqhJ_3812871652544260169.jpg" },
      { type: "image", url: "/case/noblesmoke__pochete_2026-01-18_DTp-qNlDpDJ_3812854139227902153.jpg" }
    ],
    variations: [
  ...
  },
  {
    ...
    rating: 125,
    media: [
      { type: "image", url: "/kit/noblesmoke_Vem_conferir_essas_cases_recheadas😉__tabacaria__cases__smoki_2026-02-17_DU3SN9pjsX2_3834613732115138038.jpg" },
      { type: "image", url: "/kit/noblesmoke_Vem_conferir_essas_cases_recheadas😉__tabacaria__cases__smoki_2026-02-17_DU3SN9pjsX2_3834613732115138038_2.jpg" }
    ],
  ...
  // DICHAVADORES E ACESSÓRIOS
  {
    ...
    rating: 66,
    media: [
      { type: "image", url: "/dichavador/noblesmoke_Dichavador_fibra_de_coco_personalizado!!_Os_melhores_acessór_2026-02-11_DUo0Cd3jyRQ_3830540351006778448.jpg" },
      { type: "image", url: "/dichavador/noblesmoke_Design_exclusivo,_acabamento_impecável_e_aquele_toque_que_fa_2026-02-25_DVL2XnHjhmx_3840402224325728689.jpg" }
    ],
  ...
  },
  {
    ...
    rating: 98,
    media: [
      { type: "image", url: "/acessorios/noblesmoke_Mocó_Mascotte,_lindo_e_sempre_a_melhor_qualidade_pra_vc😉__ta_2026-02-27_DVRBq5EDmjM_3841859302659614924.jpg" }
    ],
  ...
  },
  {
    ...
    rating: 45,
    media: [
      { type: "image", url: "/cinzeiro/noblesmoke_Cinzeiro_Squadafum_redondo_e_quadrado😉_Melhores_acessórios!!_2026-02-10_DUl3DAqD_w_3829709157570706495.jpg" }
    ],
    variations: [
  ...
  // PIPES & BONGS
  {
    ...
    rating: 32,
    media: [
      { type: "image", url: "/paipe/noblesmoke_Acabou_de_chegar🔥_Modelos_exclusivos,_alta_qualidade_e_acaba_2026-02-25_DVMfmT9jhpy_3840583554455968370.jpg" },
      { type: "image", url: "/paipe/noblesmoke_Aqui_vc_encontra_a_maior_variedade_de_produtos,_sempre_da_me_2026-02-16_DU0us82DmnC_3833894581927045570.jpg" }
    ],
  ...
  // JOGOS E ENTRETENIMENTO
  {
    ...
    rating: 88,
    media: [
      { type: "image", url: "/jogos/noblesmoke__baralhocopag_2026-01-18_DTp89_7jpnc_3812846702869518812.jpg" }
    ],
  ...
  },
  {
    ...
    rating: 41,
    media: [
      { type: "image", url: "/jogos/noblesmoke__Dominó_2026-01-18_DTp-fzGDpsk_3812853423595756324.jpg" },
      { type: "image", url: "/jogos/noblesmoke__domino_2026-01-18_DTp7txxDm9A_3812841190102822720.jpg" }
    ],
  ...
  // FUMO
  {
    ...
    rating: 110,
    media: [
      { type: "image", url: "/fumo/noblesmoke_O_Kumbaya_Flowers_é_um_blend_de_ervas_e_flores_naturais,_ger_2026-03-18_DWCkOGfD2JV_3855803529693192789.jpg" }
    ],
