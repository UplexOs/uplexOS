...
Canonical specialist capability. Read the linked SKILL.md for its complete mission, limits and procedure.

## Canonical contract

- Skill: `.claude/skills/specialists/backend-engineer/SKILL.md`
- Version: `1.0.0`
- Category: `specialist`
- Risk: `medium`
- Mode: `assisted`
