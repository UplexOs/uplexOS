...
tags: [agent, category-design]
---
# Frontend Design

## Mission

Canonical design capability. Read the linked SKILL.md for its complete mission, limits and procedure.

## Canonical contract

- Skill: `.claude/skills/directors/creative-director/SKILL.md`
- Version: `1.0.0`
- Category: `design`
- Risk: `medium`
- Mode: `assisted`
