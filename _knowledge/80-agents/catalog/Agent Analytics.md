...
Kernel de Governança: Coleta, analisa e otimiza a performance dos agentes e operações da UplexOS baseando-se em métricas sistêmicas.

## Canonical contract

- Skill: `.claude/skills/systems/agent-analytics/SKILL.md`
- Version: `1.0.0`
- Category: `system`
- Risk: `medium`
- Mode: `assisted`
