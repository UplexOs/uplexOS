---
id: agent-configurar-apis
type: agent
status: active
owner: configurar-apis
...
Canonical operations capability. Read the linked SKILL.md for its complete mission, limits and procedure.

## Canonical contract

- Skill: `.claude/skills/configurar-apis/SKILL.md`
- Version: `1.0.0`
- Category: `operations`
- Risk: `medium`
- Mode: `assisted`
