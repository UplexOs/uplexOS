...
tags: [agent, category-marketing]
---
# Gerar Imagens

## Mission

Canonical marketing capability. Read the linked SKILL.md for its complete mission, limits and procedure.

## Canonical contract

- Skill: `.claude/skills/gerar-imagens/SKILL.md`
- Version: `1.0.0`
- Category: `marketing`
- Risk: `medium`
- Mode: `assisted`
